...
read -p 'Do you have existing copy of Magento 2 (y/N): ' use_existing_source
if [[ $use_existing_source = 'y' ]]
    then
...
if [[ $use_existing_source != 'y' ]]
    then docker exec -it --privileged -u magento2 magento2-devbox-web php -f /home/magento2/scripts/devbox magento:download
fi
